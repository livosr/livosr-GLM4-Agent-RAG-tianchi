...
def get_sum(nums: list[int] | list[float] | list[str]) -> float:
    '''
    17
    描述:
...
if __name__ == '__main__':
    ...
    # ['b', 'a', 'c']
    print("19、save_dict_list_to_word:")
