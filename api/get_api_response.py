...
def get_legal_document_list(query_conds: dict[str, str], need_fields: list[str]) -> tuple[list[dict[str, str]], int]:
    '''
    6
    描述:
    ...
    '''
    if '涉案次数' in need_fields:
        need_fields = ['涉案金额', '原告', '被告', '案号']
    print("need_fields", need_fields)
...
if __name__ == '__main__':
    ...
    # print("2、get_company_register_name:")
    ...
    # print("4、get_sub_company_info_list:")
    ...
    print("6、get_legal_document_list:")
    ...
    # # 全部属性：['地址', '省份', '城市', '区县']
    # print("20、get_citizens_sue_citizens:")
    ...
    # print("21、get_company_sue_citizens:")
    ...
    # print("22、get_citizens_sue_company:")
    ...
    # print("23、get_company_sue_company:")
    ...
    # print("过滤结果")
    # print(filter_(input_list, info_list[1]))
